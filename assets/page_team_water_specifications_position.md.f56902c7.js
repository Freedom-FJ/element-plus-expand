import{_ as s,o as a,c as n,V as p}from"./chunks/framework.2f197f38.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"page/team/water/specifications/position.md","filePath":"page/team/water/specifications/position.md","lastUpdated":1703128693000}'),e={name:"page/team/water/specifications/position.md"},l=p(`<nav class="table-of-contents"><ul><li><a href="#目录结构">目录结构</a><ul><li><a href="#components">components</a></li><li><a href="#api目录">Api目录</a></li></ul></li></ul></nav><h2 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">vue3-template</span></span>
