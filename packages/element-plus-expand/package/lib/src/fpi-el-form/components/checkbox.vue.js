...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: $emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElCheckboxGroup), vue.mergeProps(__props.inputProps, {
        ref_key: "inputDom",
        ref: inputDom,
        ...
        default: vue.withCtx(() => [
          __props.inputProps.type === "button" ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 0 }, vue.renderList(__props.option || [], (selItem, ind) => {
            return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElCheckboxButton), vue.mergeProps(selItem, {
              key: ind,
            ...
            return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElCheckbox), vue.mergeProps(selItem, {
              key: ind,
              label: showExpr.value(selItem, "value")
            }), {
              default: vue.withCtx(() => [
