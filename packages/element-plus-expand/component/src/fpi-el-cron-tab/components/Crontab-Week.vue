    ...
    <ElForm>
        ...
        <ElFormItem>
            <ElRadio v-model="radioValue" :label="3">
                周期从星期
                <ElInputNumber v-model="cycle01" :min="1" :max="7" /> -
                <ElInputNumber v-model="cycle02" :min="1" :max="7" />
            </ElRadio>
        </ElFormItem>
        ...
        <ElFormItem>
            <ElRadio v-model="radioValue" :label="4">
                ...
                <ElInputNumber v-model="average02" :min="1" :max="7" />
            </ElRadio>
        </ElFormItem>
        ...
        <ElFormItem>
            <ElRadio v-model="radioValue" :label="5">
                本月最后一个星期
                <ElInputNumber v-model="weekday" :min="1" :max="7" />
            </ElRadio>
        </ElFormItem>
        ...
        <ElFormItem>
            <ElRadio v-model="radioValue" :label="6">
                ...
                <ElSelect v-model="checkboxList" clearable placeholder="可多选" multiple style="width: 100%;">
                    <ElOption v-for="(item, index) of weekList" :key="index" :value="index + 1">
                        {{ item }}
                    </ElOption>
                </ElSelect>
            </ElRadio>
