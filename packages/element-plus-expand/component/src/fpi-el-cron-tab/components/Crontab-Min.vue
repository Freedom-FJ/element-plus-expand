    ...
    <ElForm>
        ...
        <ElFormItem>
            <ElRadio v-model="radioValue" :label="2">
                周期从
                <ElInputNumber v-model="cycle01" :min="0" :max="60" /> -
                <ElInputNumber v-model="cycle02" :min="0" :max="60" /> 分钟
            </ElRadio>
        </ElFormItem>
        ...
        <ElFormItem>
            <ElRadio v-model="radioValue" :label="3">
                从
                <ElInputNumber v-model="average01" :min="0" :max="60" /> 分钟开始，每
                <ElInputNumber v-model="average02" :min="0" :max="60" /> 分钟执行一次
            </ElRadio>
        </ElFormItem>
