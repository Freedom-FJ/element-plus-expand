...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: $emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ElCheckboxGroup), mergeProps(__props.inputProps, {
        ref_key: "inputDom",
        ref: inputDom,
        ...
        default: withCtx(() => [
          __props.inputProps.type === "button" ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(__props.option || [], (selItem, ind) => {
            return openBlock(), createBlock(unref(ElCheckboxButton), mergeProps(selItem, {
              key: ind,
            ...
            return openBlock(), createBlock(unref(ElCheckbox), mergeProps(selItem, {
              key: ind,
              label: showExpr.value(selItem, "value")
            }), {
              default: withCtx(() => [
