...
import { defineComponent, ref, computed, watch, onMounted, nextTick, onUnmounted, openBlock, createElementBlock, createElementVNode, normalizeClass, normalizeStyle, renderSlot, createCommentVNode } from "vue";
const __default__ = {
  name: "FpiElRolling"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          ref_key: "rollingBody",
          ref: rollingBody,
          class: normalizeClass(["fpi-el-rolling", { "fpi-el-rolling-flex": __props.direction === "x" }]),
          ...
          !forcedStop.value ? renderSlot(_ctx.$slots, "default", { key: 0 }) : createCommentVNode("", true)
        ], 38)
      ], 512);
    };
  }
