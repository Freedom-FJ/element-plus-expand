...
export declare const fpiTableProps: {
    /**
     * @desc 表格列配置
    ...
    */
     ...
     */
    filterMethod: {
        type: PropType<(row: Record<string, any>, index: number, arr: Array<any>) => boolean>;
        default: undefined;
    };
    /**
     ...
     */
    resPretreatment: {
        type: PropType<(res: Record<string, any>) => (Array<Record<string, any>> | Promise<any>)>;
        default: undefined;
    };
};
