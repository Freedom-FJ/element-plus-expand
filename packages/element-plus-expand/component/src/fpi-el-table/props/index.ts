...
export const fpiTableProps = {
    ...
    */
    ...
    resExpr: {
        type: String,
        default: fpiTableConfig.value.resExpr || ''
    },
    /**
     * @desc 静态数据（当前页）
...
export const pageProps = {
    ...
    pageTotalExpr: {
        type: String,
        default: fpiTableConfig.value.pageTotalExpr || 'total'
    },
    /**
    ...
    pageInit: {
        ...
        default: () => {
            return fpiTableConfig.value.pageInit || {
                pageSizes: 10,
                currentPage: 1,
                total: 0,
    ...
    pageReqExpr: {
        ...
        default: () => {
            return fpiTableConfig.value.pageReqExpr || {
                pageSizes: 'pageSize',
                currentPage: 'pageNum'
            }
        }
    ...
    isShowPage: {
        type: Boolean,
        default: fpiTableConfig.value.isShowPage === undefined ? true : fpiTableConfig.value.isShowPage
    },
    /**
     * @desc 分页按钮类型
    ...
    currentPageOffset: {
        type: Number,
        default: fpiTableConfig.value.currentPageOffset || 0
    },
    /**
     * @desc 是否显示页码按钮背景
     */
